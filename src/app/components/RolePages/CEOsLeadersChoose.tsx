  ...
  return (
    <section className="relative isolate overflow-hidden py-16 sm:py-24">
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Quote + logo */}
        <div className="mt-8 rounded-2xl border border-[#0a2440]/10 bg-white p-6 shadow-[0_25px_60px_-35px_rgba(12,10,43,0.15)]">
          <div className="flex items-start gap-5">
            ...
            <div className="space-y-5">
              ...
              {/* Logo placeholder */}
              <div className="flex h-12 w-64 items-center justify-center rounded-md border border-dashed border-[#0a2440]/20 bg-white text-xs font-semibold uppercase tracking-wider text-[#0a2440]/60">
                Logo
              </div>
            </div>
          </div>
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <article className="rounded-2xl border border-[#0a2440]/10 bg-white p-6 shadow-[0_25px_60px_-35px_rgba(12,10,43,0.15)]">
            <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#0a2440]/5">
              <IconUsersGroup className="h-5 w-5 text-lime-400" aria-hidden />
            </div>
          ...
          <article className="rounded-2xl border border-[#0a2440]/10 bg-white p-6 shadow-[0_25px_60px_-35px_rgba(12,10,43,0.15)]">
            <div className="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#0a2440]/5">
              <IconLifebuoy className="h-5 w-5 text-lime-400" aria-hidden />
            </div>
