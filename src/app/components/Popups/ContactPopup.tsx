    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto p-6 relative">
              <button
                onClick={onClose}
              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-1/2 md:pr-8 mb-8 md:mb-0 md:border-r border-gray-200 dark:border-gray-700">
                  <div className="flex flex-col items-center justify-center space-y-6 py-4">
                    <HeadphonesIcon className="w-20 h-20 md:w-24 md:h-24 text-[#22263e] dark:text-white" />
                    <h2 className="text-xl md:text-2xl font-bold text-[#22263e] dark:text-white text-center">Support Services</h2>
                ...
                <div className="md:w-1/2 md:pl-8">
                  <h2 className="text-xl md:text-2xl font-bold mb-4 dark:text-white">Send us a message</h2>
