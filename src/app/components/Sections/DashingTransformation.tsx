...
export default function DashingTransformation() {
  return (
    <section className="relative isolate overflow-hidden bg-[#180c3c] py-20 text-white sm:py-24">
      <div
        className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,rgba(253,224,71,0.35),transparent_70%)]"
        aria-hidden
      />
      <div className="mx-auto flex max-w-5xl flex-col gap-12 px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 text-left sm:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_40px_80px_-60px_rgba(12,10,43,0.7)]">
            <h3 className="text-lg font-semibold text-amber-200">Before: The Old Way</h3>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-[0_40px_80px_-60px_rgba(12,10,43,0.7)]">
            <h3 className="text-lg font-semibold text-emerald-200">After: With Dashing</h3>
            <ul className="mt-4 space-y-3 text-sm text-white/80 sm:text-base">
        ...
        <div className="mx-auto flex w-full max-w-xl flex-col items-center gap-8">
          <div className="flex h-64 w-full items-center justify-center rounded-[2rem] border border-dashed border-white/20 bg-white/5 text-lg font-semibold uppercase tracking-[0.25em] text-white/60">
            Placeholder Image
          </div>
          <Link
            href="/contact"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-[#6D4BFF] px-6 py-3 text-base font-semibold text-white shadow-[0_25px_45px_-20px_rgba(109,75,255,0.9)] transition hover:-translate-y-0.5 hover:bg-[#5a3bdc]"
          >
