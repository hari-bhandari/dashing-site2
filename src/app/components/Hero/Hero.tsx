        ...
        <div className="text-center px-4">
          ...
          <div className="w-full max-w-sm mx-auto">
            <Image
              ...
              blurDataURL="data:image/jpeg;base64," // Add base64 blur placeholder
            />
          </div>
        </div>
      </div>
