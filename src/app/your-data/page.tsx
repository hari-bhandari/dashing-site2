  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="mt-24 md:mt-32 w-full px-4 md:max-w-[80%] lg:max-w-[60%] mx-auto">
        ...
        <p className="text-lg md:text-xl text-gray-500 text-center mx-auto dark:text-white mt-4">Your data is what makes your business unique. We understand the importance of keeping your data safe and secure. Our software is designed to work independently from your data, ensuring you have complete control over your valuable company information.</p>
      </div>
      <div className="w-full px-4 md:max-w-[80%] lg:max-w-[60%] mx-auto mb-16 md:mb-20 mt-10 md:mt-14">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h2 className="font-bold mb-2 dark:text-white">Premium Protection</h2>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h2 className="font-bold mb-2 dark:text-white">Manage Your Data</h2>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h2 className="font-bold mb-2 dark:text-white">On Your Server</h2>
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h2 className="font-bold mb-2 dark:text-white">Your Needs Matter</h2>
