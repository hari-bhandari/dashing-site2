      ...
      <div className="w-full flex flex-col gap-10 mt-14">
        ...
        <div className="flex flex-col gap-12 mx-auto mt-20"> {/* Increased gap between sections */}
          <div className='max-w-[60%] mx-auto'>
            <h1 className="text-4xl font-bold text-center mb-2">Our Motto</h1>
          ...
          <div className='max-w-[60%] mx-auto mb-20'>
            <div className="grid grid-cols-4 gap-6 mb-6">
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h3 className="font-bold mb-2">Unparalleled Customer Support</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We put our customers first by providing top-notch support, ensuring your needs are always met.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                <IconDeviceAnalytics className="w-10 h-10 text-blue-500 mb-4" />
                <h3 className="font-bold mb-2">User-Friendly Software</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Our intuitive and easy-to-use software is designed with our customers in mind, making your experience enjoyable and productive.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                <IconRotate className="w-10 h-10 text-blue-500 mb-4" />
                <h3 className="font-bold mb-2">Fast Performance</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We understand the importance of speed, so we optimize our software to perform quickly and efficiently for our customers.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                <IconUsers className="w-10 h-10 text-blue-500 mb-4" />
                <h3 className="font-bold mb-2">Evolving with Customer Needs</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We listen to our customers and continuously improve our software to meet their changing needs and expectations.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <h3 className="font-bold mb-2">Active Feedback Seekers</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We value customer feedback and actively seek it to enhance our software and deliver the best user experience.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                <IconCash className="w-10 h-10 text-blue-500 mb-4" />
                <h3 className="font-bold mb-2">Affordable Pricing</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We believe in offering high-quality software at affordable prices, making our solutions accessible to all customers.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                <IconShieldLock className="w-10 h-10 text-blue-500 mb-4" />
                <h3 className="font-bold mb-2">Long-Term Security</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">We are committed to providing long-term security to our customers by continually investing in our software and infrastructure.</p>
              </div>
            </div>
          </div>
        </div>
