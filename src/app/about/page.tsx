    ...
    <div className="flex flex-col items-center justify-center min-h-screen dark:bg-slate-950">
      ...
      <div className="w-full flex flex-col gap-10 mt-20 md:mt-32 px-4">
        ...
        <div className="flex flex-col gap-12 mx-auto mt-16 md:mt-20"> 
          ...
          <div className='w-full md:max-w-[80%] lg:max-w-[60%] mx-auto mb-16 md:mb-20 px-4'>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">We understand the importance of speed, so we optimise our software to perform quickly and efficiently for our customers.</p>
              </div>
              <div className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-lg flex flex-col items-center text-center">
